            ...
            >
                <div className="grid md:grid-cols-[1.2fr,1fr] gap-8 md:gap-12 bg-gray-900/40 backdrop-blur-xl p-8 md:p-10 rounded-2xl border border-gray-800/50 shadow-xl">
                    ...
                    <div className="flex flex-col justify-center space-y-4 md:space-y-5 md:px-4">                        
                        <button
                            onClick={() => signIn()}
                            className="w-full py-3.5 px-6 bg-gray-800/50 hover:bg-gray-700/50 text-white rounded-xl font-medium border border-gray-700/50 transition-all duration-200 group hover:shadow-lg hover:-translate-y-0.5"
                        >
                        ...
                        <button
                            onClick={() => signIn()}
                            className="w-full py-3.5 px-6 bg-[#5865F2]/10 hover:bg-[#5865F2]/20 text-white rounded-xl font-medium border border-[#5865F2]/20 transition-all duration-200 group hover:shadow-lg hover:-translate-y-0.5"
                        >
                            <div className="flex items-center justify-center gap-3">
