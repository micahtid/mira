    ...
    <section className="relative min-h-[80vh] md:min-h-[90vh] w-full overflow-hidden flex items-center justify-center">
      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-16">
        ...
        >
          ...
          >
            <span className="inline-flex items-center gap-2 px-4 md:px-6 py-2 rounded-full bg-primary-100/80 backdrop-blur-sm text-primary-600 text-xs md:text-sm font-medium shadow-lg border border-primary-200/50">
              <span className="relative flex h-2 w-2">
                <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-primary-400 opacity-75" />
                <span className="relative inline-flex rounded-full h-2 w-2 bg-primary-500" />
              </span>
              {!isMobile ? "Connecting Students with Meaningful Volunteer Opportunities" : "Find Volunteer Opportunities"}
            </span>
          </motion.div>
